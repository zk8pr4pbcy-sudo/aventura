(function () {
  ...
  /*
   * SEO metadata is owned by seo-runtime.js. ga4.js only bootstraps that
   * focused runtime so existing HTML entry points do not need a risky
   * all-pages script-tag migration in this phase.
   */
  function loadSeoRuntime() {
    if (window.AVENTURA_SEO || document.querySelector('script[data-aventura-seo-runtime]')) return;
    var script = document.createElement("script");
    script.src = "assets/js/seo-runtime.js?v=20260911";
    script.async = false;
    script.setAttribute("data-aventura-seo-runtime", "true");
