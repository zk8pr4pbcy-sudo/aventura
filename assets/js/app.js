(function () {
  ...
  function headerMarkup() {
    return [
      ...
      '        <span class="brand-name">AVENTURA</span>',
      '        <span class="brand-tagline" data-i18n="brand.tagline">Experiences · Events · Hospitality</span>',
      '      </span>',
      '    </a>',
  ...
  function footerMarkup() {
    return [
      ...
      '      <a class="brand" href="index.html" aria-label="AVENTURA home">',
      '        <span class="brand-mark" aria-hidden="true">A</span>',
      '        <span class="brand-copy"><span class="brand-name">AVENTURA</span><span class="brand-tagline" data-i18n="brand.tagline">Experiences · Events · Hospitality</span></span>',
      '      </a>',
