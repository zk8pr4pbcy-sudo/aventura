(function () {
  ...
  var REQUEST_TYPES = {
    en: [["", "Choose one"], ["historic-jeddah", "Historic Jeddah experience"], ["sea", "Red Sea experience"], ["desert", "Desert experience"], ["taif", "Taif journey"], ["jeddah-day", "A complete Jeddah day"], ["corporate", "Corporate program"], ["private-event", "Private event or occasion"], ["vip-hosting", "VIP or delegation hosting"], ["custom-experience", "Design a custom experience"], ["partnership", "Partnership or collaboration"], ["general-inquiry", "General inquiry"]],
    ar: [["", "اختر النوع"], ["historic-jeddah", "جولة جدة التاريخية"], ["sea", "تجربة بحرية"], ["desert", "تجربة صحراوية"], ["taif", "رحلة إلى الطائف"], ["jeddah-day", "يوم متكامل في جدة"], ["corporate", "برنامج شركات"], ["private-event", "فعالية أو مناسبة خاصة"], ["vip-hosting", "استضافة كبار الشخصيات أو الوفود"], ["custom-experience", "تصميم تجربة خاصة"], ["partnership", "تعاون أو شراكة"], ["general-inquiry", "استفسار عام"]],
    es: [["", "Elige una opción"], ["historic-jeddah", "Experiencia en Yeda Histórica"], ["sea", "Experiencia en el Mar Rojo"], ["desert", "Experiencia en el desierto"], ["taif", "Viaje a Taif"], ["jeddah-day", "Un día completo en Yeda"], ["corporate", "Programa corporativo"], ["private-event", "Evento u ocasión privada"], ["vip-hosting", "Atención VIP o delegaciones"], ["custom-experience", "Diseñar una experiencia a medida"], ["partnership", "Colaboración o alianza"], ["general-inquiry", "Consulta general"]]
  };

  var FORM_TEXT = {
    en: {customize:"Add what suits your guests",optional:"Optional additions",includedGuide:"A licensed tour guide is included in every Historic Jeddah tour.",guideLanguage:"Guide language",chooseLanguage:"Choose a language",languages:["Arabic","English","Spanish","French","German","Italian","Russian","Chinese","Japanese","Other"],period:"Preferred period",periodOptions:["Morning","Sunset","Evening","Flexible"],seaDuration:"Sea experience duration",durationOptions:["One hour","Half day","Full day","Flexible"],companyCity:"City",eventType:"Occasion type",eventLocation:"Preferred location",arrivalDate:"Arrival date",activityType:"Business activity",partnershipDetails:"Collaboration details",customDetails:"Describe the experience you would like",included:"Included",addons:{airport:"Airport meet and assist",transport:"Private transportation",dining:"Dining arrangements",photography:"Professional photography",boutique:"Aventura Boutique items",resort:"Resort or private beach",hospitality:"Private hospitality setup",hotel:"Hotel arrangements",interpreter:"Interpreter",gifts:"Guest gifts",coordination:"Full event coordination",flowers:"Flowers and gifts",vipCar:"VIP vehicle",tailor:"Tailor at the hotel",abaya:"Abaya service"}},
    ar: {customize:"أضف ما يناسب ضيوفك",optional:"إضافات اختيارية",includedGuide:"تشمل كل جولة في جدة التاريخية مرشدًا سياحيًا مرخصًا.",guideLanguage:"لغة المرشد",chooseLanguage:"اختر اللغة",languages:["العربية","الإنجليزية","الإسبانية","الفرنسية","الألمانية","الإيطالية","الروسية","الصينية","اليابانية","لغة أخرى"],period:"الفترة المفضلة",periodOptions:["صباحية","وقت الغروب","مسائية","مرنة"],seaDuration:"مدة التجربة البحرية",durationOptions:["ساعة واحدة","نصف يوم","يوم كامل","مرنة"],companyCity:"المدينة",eventType:"نوع المناسبة",eventLocation:"الموقع المفضل",arrivalDate:"تاريخ الوصول",activityType:"نوع النشاط",partnershipDetails:"تفاصيل التعاون",customDetails:"صف لنا التجربة التي ترغب بها",included:"مشمول",addons:{airport:"استقبال ومساعدة في المطار",transport:"نقل خاص",dining:"ترتيبات المطاعم",photography:"تصوير احترافي",boutique:"منتجات بوتيك أفنتورا",resort:"منتجع أو شاطئ خاص",hospitality:"جلسة ضيافة خاصة",hotel:"ترتيبات الفندق",interpreter:"مترجم",gifts:"هدايا للضيوف",coordination:"تنسيق كامل للفعالية",flowers:"ورد وهدايا",vipCar:"سيارة VIP",tailor:"خياط في الفندق",abaya:"خدمة العباية"}},
    es: {customize:"Añade lo que mejor se adapte a tus invitados",optional:"Complementos opcionales",includedGuide:"Todas las visitas a Yeda Histórica incluyen un guía turístico autorizado.",guideLanguage:"Idioma del guía",chooseLanguage:"Elige un idioma",languages:["Árabe","Inglés","Español","Francés","Alemán","Italiano","Ruso","Chino","Japonés","Otro"],period:"Periodo preferido",periodOptions:["Mañana","Atardecer","Noche","Flexible"],seaDuration:"Duración de la experiencia marina",durationOptions:["Una hora","Medio día","Día completo","Flexible"],companyCity:"Ciudad",eventType:"Tipo de ocasión",eventLocation:"Lugar preferido",arrivalDate:"Fecha de llegada",activityType:"Actividad de la empresa",partnershipDetails:"Detalles de la colaboración",customDetails:"Describe la experiencia que deseas",included:"Incluido",addons:{airport:"Recepción y asistencia en el aeropuerto",transport:"Transporte privado",dining:"Reservas gastronómicas",photography:"Fotografía profesional",boutique:"Artículos de Aventura Boutique",resort:"Resort o playa privada",hospitality:"Hospitalidad privada",hotel:"Alojamiento en hotel",interpreter:"Intérprete",gifts:"Regalos para huéspedes",coordination:"Coordinación completa del evento",flowers:"Flores y regalos",vipCar:"Vehículo VIP",tailor:"Sastre en el hotel",abaya:"Servicio de abaya"}}
  };

  var REQUEST_CONFIG = {
    "historic-jeddah": {guide:true,addons:["airport","transport","dining","photography","boutique"]},
    "sea": {period:true,seaDuration:true,addons:["resort","transport","photography","boutique"]},
    "desert": {period:true,addons:["transport","hospitality","photography","boutique"]},
    "taif": {addons:["transport","dining","photography","boutique"]},
    "jeddah-day": {addons:["transport","dining","photography","boutique"]},
    "corporate": {city:true,addons:["airport","hotel","interpreter","gifts","boutique"]},
    "private-event": {eventType:true,eventLocation:true,addons:["coordination","photography","flowers"]},
    "vip-hosting": {arrivalDate:true,addons:["airport","vipCar","hotel","dining","tailor","abaya","boutique"]},
    "custom-experience": {customDetails:true,addons:[]},
    "partnership": {activityType:true,partnershipDetails:true,addons:[]},
    "general-inquiry": {addons:[]}
  };
