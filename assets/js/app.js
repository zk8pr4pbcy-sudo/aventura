(function () {
  ...
  function setupContactForm() {
    ...
    var contactWizard = window.AVENTURA_CONTACT_WIZARD;
    ...
    form.addEventListener("submit", function (event) {
      ...
      var requestId = contactRequestData.createRequestId();
